...
function open_win()
{
	...
	{
	   w1 = window.open("analyzeByRetweet.do", "", "width=600, height=400,scrollbars=yes");
	   w1.focus();
	}
	if(document.getElementById('reportType3').checked)
	{
	   w1 = window.open("analyzeByMention.do", "", "width=600, height=400,scrollbars=yes");
	   w1.focus();
	}
}
